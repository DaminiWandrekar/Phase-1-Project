...
public class OprationList {
	...
	OperationDisplay dis = new OperationDisplay();
	
	public void introScreen() {
		System.out.println();
		System.out.println("|-------------------------------------------------|");
		System.out.println("|***    DEVELOPED BY DAMINI PRAMOD WANDREKAR   ***|");
		System.out.println("|-------------------------------------------------|");
	...
	public void mainMenuOptions() {
	    ...
	    System.out.println("|   2 - All Options                 |");
	...
	public void subMenu() {
		...
		do {
			...
			case 1: 
					...
					fileName = file.trim();
					try {
						dis.createNewFile(Main.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IOException e) {
			...
			case 2: 
					...
					fileName = file.trim();
					try {
						dis.deleteFile(Main.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IOException e) {
			...
			case 3: 
					...
					fileName = file.trim();
					try {
						dis.searchFile(Main.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IllegalArgumentException e) {
						System.out.println(e.getMessage());
